...
<div class="wrap">
  ...
  <footer>
    Generated by <strong>LISA MCP Server</strong> using Azure OpenAI &nbsp;|&nbsp;
...
def generate_markdown_report(report: AnalysisReport) -> str:
    ...
    lines += [
        ...
        "---",
        "",
        "_Generated by [LISA MCP Server](https://github.com/kkkashan/LISA_MCP_Server) using Azure OpenAI_",
    ]
    return "\n".join(lines)
